...
For new projects, we recommend using the native async API in pulsing.core.
...
Migration from Ray:
    ...
    from pulsing.integrations.ray_compat import ray  # Only change this line!
...
For better performance in async environments, use pulsing.core directly.
"""
...
# Self-reference so that "from pulsing.integrations.ray_compat import ray" works
ray = sys.modules[__name__]
